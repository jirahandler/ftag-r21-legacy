...
void ATLASLabelLumi(Double_t x,Double_t y,const char* text=NULL,Color_t color=1); 

void ATLASLabelLumiSqrt(Double_t x,Double_t y,const char* text=NULL,Color_t color=1); 

void ATLASLabelSqrt(Double_t x,Double_t y,const char* text=NULL,Color_t color=1); 

void ATLASLabelSimulation(Double_t x,Double_t y,const char* text=NULL,Color_t color=1); 
