...
StatusCode btagAnalysisAlg::execute() {
 ...
 int npv = *npv_p;
  ...
  if (pdgid/10 == 100002) // gluino 1000021, neutralino 1000022
  ...
  //if (pdgid == 36) // SUSY Higgs (A0)
  {
	...
	if (ok) {
      ...
      // A.X.: LLP
      LLPDecayProd.insert(std::pair<int, std::vector<const xAOD::TruthParticle*>>(nLLP, {})); // protection from childfree LLPs
