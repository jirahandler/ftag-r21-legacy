...
namespace InDet {
  ...
  enum TrackSystematic {
    ...
    TRK_RES_D0_DEAD,
    TRK_RES_Z0_DEAD,
    TRK_RES_D0_MEAS_DiJetMap,
    TRK_RES_Z0_MEAS_DiJetMap,
...
#define DEF_SYST( NAME ) {TRK_##NAME, CP::SystematicVariation("TRK_" #NAME )}
    ...
    DEF_SYST( RES_D0_MEAS_UP ),
    DEF_SYST( RES_Z0_MEAS_UP ),
    DEF_SYST( RES_D0_MEAS_DOWN ),
    DEF_SYST( RES_Z0_MEAS_DOWN ),
    DEF_SYST( RES_D0Z0_MEAS ),
    DEF_SYST( RES_D0Z0Corl_MEAS ),
    DEF_SYST( RES_D0_DEAD ),
    DEF_SYST( RES_Z0_DEAD ),
    DEF_SYST( RES_D0_MEAS_DiJetMap ),
    DEF_SYST( RES_Z0_MEAS_DiJetMap ),
    DEF_SYST( BIAS_D0_WM ),
    DEF_SYST( BIAS_Z0_WM ),
